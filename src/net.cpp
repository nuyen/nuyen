...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "nuyen " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"nuyentools.com", "dnsseed.nuyentools.com"},
    {"nuyenpool.org", "dnsseed.nuyenpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"nuyentools.com", "testnet-seed.nuyentools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. nuyen is probably already running."), addrBind.ToString().c_str());
        else
